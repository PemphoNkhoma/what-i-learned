...
Why the Caesar Cipher is not secure today and how brute-force can break it easily.
Some basics of organizing code into functions to make it easier to read and use.
That small projects like this are a good way to start learning cybersecurity and build confidence in coding.
